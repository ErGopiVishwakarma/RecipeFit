...
const Feedback = () => {
    return (
        <Box style={{position: 'fixed', bottom: "35px", right: "35px", transition: "opacity 0.3s"}} _hover={{opacity: "0.8"}}>
            <a id="feedback-button" href="/feedback" title="Feedback">
                <svg width="34pt" height="34pt" viewBox="0 -1 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ backgroundColor: "#50684B", borderRadius: "50%", padding: "7px" }}>
                    <g stroke-width="0"></g>
